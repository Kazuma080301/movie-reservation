...
const { registerSchema, loginSchema, forgotPasswordSchema, resetPasswordSchema } = require('../user/user.validator')
const { validateSchema } = require('../../middlewares/validateMiddleware')
const { protect } = require('./auth.middleware');
const createRateLimiter = require("../../utils/rateLimiter");
const { registerUser, loginUser, updatePassword, forgotPassword, resetPassword } = require('./auth.controller');
